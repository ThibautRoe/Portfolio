...
export default function RootLayout({ children }) {
    return (
      <html
        ...
        // The downside is that it breaks scroll position restoration on all browsers but Firefox (at least up to Firefox 124, not tested on more recent releases). Scroll restoration on anchors links (http://thibautroegiers.dev/#skills for example) on page refresh still works on Firefox and Safari but not on Chrome based browsers (Chrome, Opera, Arc, etc.).
      >
        <head>
          <link
            rel="preload"
