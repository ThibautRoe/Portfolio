...
export default function Header() {
    return (
      <header
        id="home"
        className="nav-anchor color-transition bg-custom-400 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 lg:text-neutral-600 dark:lg:text-neutral-50 snap-start h-[1px] lg:h-auto"
      >
        ...
        <div className="lg:u-container">
          <div className="flex">
            <AnimatedText
              ...
              text="<Thibaut />"
              el="p"
              className="hidden lg:inline text-t-fl-2xl"
            />
