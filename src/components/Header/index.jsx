...
export default function Header() {
    ...
    return (
        <header
            id="home"
            className="nav-anchor lg:bg-custom-400 dark:lg:bg-neutral-800 text-neutral-600 dark:text-neutral-400 lg:text-neutral-50 dark:lg:text-neutral-50 snap-start h-[1px] lg:h-auto"
        >
