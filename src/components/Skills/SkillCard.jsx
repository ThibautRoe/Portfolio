                        ...
                        {hoveredIndex === item.id && (
                            <div className="absolute -top-s-fl-l left-1/2 -translate-x-1/2 z-50">
                                <motion.div
                                    ...
                                    className="rounded-s-fl-3xs bg-neutral-100 text-neutral-600 drop-shadow-xl py-s-fl-3xs px-s-fl-2xs"
                                >
                        ...
                        <Link key={`link-${item.id}`} href={item.officialWebsite} target="_blank" rel="noopener noreferrer">
                            ...
                            >
                                <div
                                    ...
                                    className="skill-card rounded-s-fl-xs h-s-fl-2xl w-s-fl-2xl overflow-hidden bg-gradient-to-br from-neutral-100 to-neutral-300 p-s-fl-2xs drop-shadow-md lg:hover:drop-shadow-lg"
                                >
