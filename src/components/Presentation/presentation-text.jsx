...
export default function PresentationText() {
    ...
    return (
      <>
        ...
        <span className="font-bold">développeur web fullstack</span>
        <span> spécialisé dans le </span>
        ...
        <span>
          , j'avais depuis longtemps des bases solides en HTML/CSS/JS, que j'ai
          perfectionnées grâce à une{" "}
        </span>
        ...
        <span> tels que React / Next.js et Node.js.</span>
        <br />
        <br />
